...
import { ArrowLeft, Calendar, Edit, Mail, Plus, Shield, User as UserIcon } from "lucide-react";
...
import { UserResponse, UpdateUserRequest, StatusEnum } from "@/features/users/schemas/users.schemas";
...
function UserDetailPage() {
    ...
    const handleUpdateUserSubmit = async (data: UpdateUserRequest) => {
        if (!user) return;
